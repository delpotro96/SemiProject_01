...
<div class="form-group">
    ...
    <input name="bno" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
...
<div class="form-group">
    ...
    <input name="title" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
           value='<c:out value="${pageInfo.title}"/>' readonly="readonly">
</div>
<div class="form-group">
    <label for="exampleTextarea" class="form-label mt-4">게시판 내용</label>
    <br><br>
    <iframe id="iframeId" width="560" height="315" src="https://www.youtube.com/embed/${pageInfo.youtube }"
            title="YouTube video player" frameborder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowfullscreen></iframe>
    <br>
    <br><br>
    <div name="content" class="form-control" id="exampleTextarea" rows="3" readonly="readonly"><c:out
...
<div class="form-group">
    ...
    <input name="writer" type="text" class="form-control" id="exampleInputPassword1" readonly="readonly"
           value='<c:out value="${pageInfo.writer}"/>'>
</div>
<div class="form-group">
    <label for="exampleInputPassword1" class="form-label mt-4">게시판 등록일</label>
    <input name="regdate" type="text" class="form-control" id="exampleInputPassword1" readonly="readonly"

    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
        	...
        	<button type="button" class="btn btn-primary" onclick='window.open("html/memberInsert.html", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=100,left=300,width=400,height=550");'>SignUp</button>
        </li>
      </ul>
      <form class="d-flex">
      </form>
